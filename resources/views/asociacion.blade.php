         ...
         <div class="col-12 p-3 shadow-lg rounded-3">
            ...
            <form action="{{route('fase1')}}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 text-center">
                    <h1 class="h2 fw-bold m-0">VINCULACIÓN VIRTUAL COMO ASOCIADO ó ACTUALIZACIÓN DE DATOS<i class="fa-solid fa-caret-down"></i></h1>
                </div>
                    ...
                    <div class="row m-0 mb-2 align-items-center">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center">
                                ...
                                <input type="number" id="celular1" class="form-control border border-dark" placeholder="Número de celular" name="celular1" required>
                            </div>
                        </div>
                    </div>
