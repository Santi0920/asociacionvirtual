...
<optgroup label="Otros Países">
    ...
    <option data-countryCode="BH" value="973">Baréin (+973)</option>
    ...
    <option data-countryCode="CY" value="90392">Chipre del Norte (+90392)</option>
    <option data-countryCode="CY" value="357">Chipre del Sur (+357)</option>
    ...
    <option data-countryCode="FK" value="500">Islas Malvinas (+500)</option>
    <option data-countryCode="FO" value="298">Islas Feroe (+298)</option>
    ...
    <option data-countryCode="NF" value="672">Isla Norfolk (+672)</option>
    ...
    <option data-countryCode="PS" value="970">Palestina (+970)</option>
    ...
    <option data-countryCode="SZ" value="268">Esuatini (+268)</option>
    ...
    <option data-countryCode="TC" value="1649">Turks &amp; Islas Caicos (+1649)</option>
    ...
    <option data-countryCode="VG" value="1284">Islas Vírgenes Británicas (+1284)</option>
    <option data-countryCode="VI" value="1340">Islas Vírgenes de los Estados Unidos (+1340)</option>
